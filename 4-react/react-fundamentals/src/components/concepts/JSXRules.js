...
const JSXRules = () => {
  ...
  const CreateElementComponent = () => {
    ...
    React.createElement("h1", null, "Create Element"),
    React.createElement("p", null,"This was constructed with Create Element calls in the return."),
    React.createElement("img", {
      src: 'https://cdn-images-1.medium.com/max/1200/1*jJZHFQmhkq_7ohn18KrMhA.png'}, null)
    )
}
