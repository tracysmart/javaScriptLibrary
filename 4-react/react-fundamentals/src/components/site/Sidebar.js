...
import {
  ...
  import Hooks2 from '../concepts/Hooks2';
  import TimePiecesApp from '../apps/timer-apps/TimePiecesApp';
  import NytApp from '../apps/nyt-app/NytApp';
  import MovieApp from '../apps/movieAppDisplay/MovieApp';
  ...
  const Sidebar = () => (
    ...
    <li><Link to="/reactconceptschecklist"></Link></li>
    ...
    <Switch>
      ...
      <Route exact path="/movieapp"></Route>
      <Route exact path="/bitcoin"></Route>
      <Route exact path="/reactconceptschecklist"></Route>
    </Switch>
    </div>
    </div>
  )
